...
@Autonomous(name = "Red Back AutoL")
public class RedBackAutoL extends CommandOpMode {
...
//            telemetry.addData("Path:", robot.pipeline.getPropLocation());
        ...
        switch (chosen) {
            case LEFT:
                ...
                repose1 = new Pose( 2,2.5,Math.PI*1);
                repose2 = new Pose( 55,3.5,Math.PI*1);
                yellow_pose = new Pose(83,34,Math.PI / 2);
                break;
            case  CENTER:
            ...
            default:
                ...
                yellow_pose = new Pose(80, 23, Math.PI/2);
